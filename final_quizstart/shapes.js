...
/**
 * Create a multi-texture cube as a single model with material indices
 * @param {number} size Cube size
 * @param {number[]} color Base color
 * @param {number[]} offset Position offset
 * @returns {Vertex[]} Cube vertices with material indices for each face
 */
function createMultiTextureCubeVertices(size = 1, color = [1,1,1,1], offset = [0,0,0]) {
    const w = size / 2;
    const h = size / 2;  // Fix: add missing h variable
    const [x, y, z] = offset;
    
    return [
        // Front face (material index 0)
        { position: [x-w, y-h, z+w], color, uv: [0, 0], normal: [0, 0, 1], materialIndex: 0 },
        { position: [x+w, y-h, z+w], color, uv: [1, 0], normal: [0, 0, 1], materialIndex: 0 },
        { position: [x+w, y+h, z+w], color, uv: [1, 1], normal: [0, 0, 1], materialIndex: 0 },
        { position: [x-w, y-h, z+w], color, uv: [0, 0], normal: [0, 0, 1], materialIndex: 0 },
        { position: [x+w, y+h, z+w], color, uv: [1, 1], normal: [0, 0, 1], materialIndex: 0 },
        { position: [x-w, y+h, z+w], color, uv: [0, 1], normal: [0, 0, 1], materialIndex: 0 },
        
        // Back face (material index 1)
        { position: [x+w, y-h, z-w], color, uv: [0, 0], normal: [0, 0, -1], materialIndex: 1 },
        { position: [x-w, y-h, z-w], color, uv: [1, 0], normal: [0, 0, -1], materialIndex: 1 },
        { position: [x-w, y+h, z-w], color, uv: [1, 1], normal: [0, 0, -1], materialIndex: 1 },
        { position: [x+w, y-h, z-w], color, uv: [0, 0], normal: [0, 0, -1], materialIndex: 1 },
        { position: [x-w, y+h, z-w], color, uv: [1, 1], normal: [0, 0, -1], materialIndex: 1 },
        { position: [x+w, y+h, z-w], color, uv: [0, 1], normal: [0, 0, -1], materialIndex: 1 },
        
        // Top face (material index 2)
        { position: [x-w, y+h, z-w], color, uv: [0, 0], normal: [0, 1, 0], materialIndex: 2 },
        { position: [x-w, y+h, z+w], color, uv: [1, 0], normal: [0, 1, 0], materialIndex: 2 },
        { position: [x+w, y+h, z+w], color, uv: [1, 1], normal: [0, 1, 0], materialIndex: 2 },
        { position: [x-w, y+h, z-w], color, uv: [0, 0], normal: [0, 1, 0], materialIndex: 2 },
        { position: [x+w, y+h, z+w], color, uv: [1, 1], normal: [0, 1, 0], materialIndex: 2 },
        { position: [x+w, y+h, z-w], color, uv: [0, 1], normal: [0, 1, 0], materialIndex: 2 },
        
        // Bottom face (material index 3)
        { position: [x-w, y-h, z+w], color, uv: [0, 0], normal: [0, -1, 0], materialIndex: 3 },
        { position: [x-w, y-h, z-w], color, uv: [1, 0], normal: [0, -1, 0], materialIndex: 3 },
        { position: [x+w, y-h, z-w], color, uv: [1, 1], normal: [0, -1, 0], materialIndex: 3 },
        { position: [x-w, y-h, z+w], color, uv: [0, 0], normal: [0, -1, 0], materialIndex: 3 },
        { position: [x+w, y-h, z-w], color, uv: [1, 1], normal: [0, -1, 0], materialIndex: 3 },
        { position: [x+w, y-h, z+w], color, uv: [0, 1], normal: [0, -1, 0], materialIndex: 3 },
        
        // Right face (material index 4)
        { position: [x+w, y-h, z+w], color, uv: [0, 0], normal: [1, 0, 0], materialIndex: 4 },
        { position: [x+w, y-h, z-w], color, uv: [1, 0], normal: [1, 0, 0], materialIndex: 4 },
        { position: [x+w, y+h, z-w], color, uv: [1, 1], normal: [1, 0, 0], materialIndex: 4 },
        { position: [x+w, y-h, z+w], color, uv: [0, 0], normal: [1, 0, 0], materialIndex: 4 },
        { position: [x+w, y+h, z-w], color, uv: [1, 1], normal: [1, 0, 0], materialIndex: 4 },
        { position: [x+w, y+h, z+w], color, uv: [0, 1], normal: [1, 0, 0], materialIndex: 4 },
        
        // Left face (material index 5)
        { position: [x-w, y-h, z-w], color, uv: [0, 0], normal: [-1, 0, 0], materialIndex: 5 },
        { position: [x-w, y-h, z+w], color, uv: [1, 0], normal: [-1, 0, 0], materialIndex: 5 },
        { position: [x-w, y+h, z+w], color, uv: [1, 1], normal: [-1, 0, 0], materialIndex: 5 },
        { position: [x-w, y-h, z-w], color, uv: [0, 0], normal: [-1, 0, 0], materialIndex: 5 },
        { position: [x-w, y+h, z+w], color, uv: [1, 1], normal: [-1, 0, 0], materialIndex: 5 },
        { position: [x-w, y+h, z-w], color, uv: [0, 1], normal: [-1, 0, 0], materialIndex: 5 },
    ];
}
