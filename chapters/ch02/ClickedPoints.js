...
function main() {
  ...
  canvas.onmousedown = function(ev){ click(ev, gl, canvas, a_Position, gl2, a_Position2); };
...
function click(ev, gl, canvas, a_Position, gl2, a_Position2) {
